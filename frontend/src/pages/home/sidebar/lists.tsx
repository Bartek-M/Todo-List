export function Lists() {
    return (
        <div className="list-group py-4 px-4 gap-1">
            <button className="btn list-group-item-action mb-3 fw-medium" onClick={() => { document.getElementById("sidebar")?.classList.toggle("hidden") }}>
                <svg width="16" height="16" fill="#469ffc" viewBox="0 0 16 16">
            ...
            <button className="btn list-group-item-action fw-medium">
                <svg width="16" height="16" fill="#fdd314" viewBox="0 0 16 16">
                    <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z" />
                </svg>
                {"\u00A0"} Today
            </button>
            <button className="btn list-group-item-action fw-medium">
                <svg width="16" height="16" fill="#f94876" viewBox="0 0 16 16">
            ...
            <button className="btn list-group-item-action fw-medium">
                <svg width="16" height="16" fill="#3aa08b" viewBox="0 0 16 16">
            ...
            <button className="btn list-group-item-action mb-3 fw-medium">
                <svg width="16" height="16" fill="#c9c090" viewBox="0 0 16 16">
                    <path d="M12.643 15C13.979 15 15 13.845 15 12.5V5H1v7.5C1 13.845 2.021 15 3.357 15zM5.5 7h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1M.8 1a.8.8 0 0 0-.8.8V3a.8.8 0 0 0 .8.8h14.4A.8.8 0 0 0 16 3V1.8a.8.8 0 0 0-.8-.8z" />
                </svg>
                {"\u00A0"} Someday
            </button>
            <button className="btn list-group-item-action fw-medium">
                <svg width="16" height="16" fill="#47b378" viewBox="0 0 16 16">
