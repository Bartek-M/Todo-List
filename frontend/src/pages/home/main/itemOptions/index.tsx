    ...
    return (
        <div className="d-flex justify-content-between">
            ...
            <div className="d-flex align-items-end ms-auto ">
                <DatePick title="When" name="item-scheduled" icon={[
                ...
                ]} changeEvent={(time) => { console.log(`Scheduled date: ${time}`); }} />
                <DatePick title="Deadline" name="item-deadline" icon={[
                ...
                <ListSelect listId={item.todo_list} />
                <button className="btn border-0 py-1 px-2" title="Delete item" onClick={() => console.log("Delete item")}>
                    <SVG fill={defaultIconFill} paths={[
